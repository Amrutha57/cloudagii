                        ...
                        <AnimatePresence mode="wait">
                            ...
                            {step === 0 && (
                                ...
                                >
                                    ...
                                    <h2 className="text-2xl font-bold text-white mb-2 uppercase tracking-tighter italic font-outfit">Analyzing Business <span className="heading-gradient">Context</span></h2>
                            ...
                            {step === 1 && (
                                ...
                                >
                                    <div className="text-center">
                                        <h3 className="text-3xl font-extrabold text-white mb-4 italic uppercase tracking-tighter font-outfit">Select Optimization <span className="heading-gradient">Focus</span></h3>
                                        <p className="text-gray-400 font-medium">Which department needs the most intelligent leverage?</p>
                                    </div>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {[
                                            ...
                                            <button
                                                ...
                                                className="group relative p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-blue-500/50 hover:bg-blue-500/5 transition-all text-left active-scale"
                                            >
                                                <div className="text-3xl mb-3 group-hover:scale-110 transition-transform">{opt.icon}</div>
                                                <div className="font-bold text-lg text-white group-hover:text-blue-400 transition-colors uppercase tracking-tight">{opt.label}</div>
                                                <div className="text-[10px] text-gray-500 mt-1 uppercase tracking-architect block">Configurable Area</div>
                                            </button>
                                        ))}
                                    </div>
                                </motion.div>
                            ...
                            {step === 2 && (
                                ...
                                >
                                    <div className="text-center">
                                        <h3 className="text-3xl font-extrabold text-white mb-4 italic uppercase tracking-tighter font-outfit">Workload <span className="heading-gradient">Intensity</span></h3>
                                        <p className="text-gray-400 font-medium">Roughly how many hours are manual in {answers.focus} weekly?</p>
                                    </div>
                            ...
                            {step === 3 && (
                                ...
                                >
                                    <div className="text-center space-y-4">
                                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/10 border border-green-500/20 rounded-full text-green-400 text-[10px] font-bold uppercase tracking-widest mb-4">
                                            <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                                            Optimal Architecture Locked
                                        </div>
                                        <h3 className="text-4xl md:text-5xl font-black text-white leading-none italic uppercase tracking-tighter font-outfit">Your <span className="heading-gradient">Blueprint</span> Ready</h3>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        <Link
                                            href="/contact"
                                            onClick={onClose}
                                            className="block w-full py-4 md:py-6 bg-white text-black font-black text-xl md:text-2xl rounded-2xl hover:bg-blue-50 hover:shadow-2xl transition-all text-center hover:scale-[1.02]"
                                        >
