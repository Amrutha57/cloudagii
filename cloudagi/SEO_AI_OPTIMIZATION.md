...
- ✅ Added comprehensive AI crawler support:
  ...
  - cohere-ai (Cohere)
- ✅ Updated disallow rules: `/api/`, `/.next/`, `/admin/`
...
✅ ChatGPT, Claude, Gemini can access and index your content
✅ Perplexity AI can cite your content in answers
✅ AI models understand your services and can recommend you
✅ Structured data helps AI give accurate information about CloudAGI

### For Business
✅ Better discoverability in AI-powered search
✅ Accurate representation when AI models discuss your services
✅ Increased referrals from AI assistants
