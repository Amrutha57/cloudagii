              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="text-gray-400 space-y-2 text-sm">
                    <li>ΓÇó <span className="font-medium">A Builder, Not Just a Theorist:</span> Shipped numerous AI products and proof-of-concepts with proven track records of turning ideas into working solutions</li>
                    <li>ΓÇó <span className="font-medium">Full-Stack AI Expertise:</span> From backend development (Python, FastAPI) to UI (Streamlit) and architecting end-to-end AI systems</li>
                    <li>ΓÇó <span className="font-medium">Hands-On with Modern Tools:</span> Constantly testing and implementing with the latest, most effective agentic AI tools</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="text-gray-400 space-y-2 text-sm">
                    <li>ΓÇó <span className="font-medium">MBA-Informed Approach:</span> Background in business analysis, project management, and entrepreneurship</li>
                    <li>ΓÇó <span className="font-medium">Product Mindset:</span> Doesn&apos;t just deliver codeΓÇöhelps you design solutions your team can actually use</li>
                    <li>ΓÇó <span className="font-medium">Thought Leadership:</span> Actively shaping conversations about AI&apos;s practical application</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              We&apos;ll identify your biggest automation opportunities and show you the exact impact you can expect. No obligation, no pressureΓÇöjust practical insights.
            </p>
